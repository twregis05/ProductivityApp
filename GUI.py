...
class MainAppScreen(Screen):
    def __init__(self, **kwargs):
        ...
        leaderBut = Button(text="Leaderboards", font_size=16)
        homepageBut = Button(text="Home", font_size=16)
        suggestionBut = Button(text="AI Suggestions", font_size=16)
        profileBut = Button(text="My Account", font_size=16)
